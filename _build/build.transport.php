...
/* define package */
define('PKG_NAME','TinyMCE RTE');
define('PKG_NAME_LOWER','tinymcerte');
define('PKG_NAMESPACE','tinymcerte');
...
$plugin->set('plugincode', getSnippetContent($sources['plugins'] . 'tinymcerte.plugin.php'));
