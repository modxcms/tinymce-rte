<?php
/**
 * Default Russian Lexicon Entries for TinyMCE Rich Text Editor
 *
 * @package tinymcerte
 * @subpackage lexicon
 */
...
$_lang['setting_tinymcerte.toolbar2_desc'] = 'Этот параметр позволяет управлять тем, какие кнопки вы хотите отображать на панели инструментов. <a href="https://www.tiny.cloud/docs-4x/configure/editor-appearance/#toolbar">https://www.tiny.cloud/docs-4x/configure/editor-appearance/#toolbar</a>';
$_lang['setting_tinymcerte.toolbar3'] = 'Панель инструментов 3';
$_lang['setting_tinymcerte.toolbar3_desc'] = 'Этот параметр позволяет управлять тем, какие кнопки вы хотите отображать на панели инструментов. <a href="https://www.tiny.cloud/docs-4x/configure/editor-appearance/#toolbar">https://www.tiny.cloud/docs-4x/configure/editor-appearance/#toolbar</a>';
...
$_lang['setting_tinymcerte.link_class_list_desc'] = 'Список классов для ссылок. <a href="https://www.tiny.cloud/docs-4x/plugins/link/#link_class_list">https://www.tiny.cloud/docs-4x/plugins/link/#link_class_list</a>';
$_lang['setting_tinymcerte.links_across_contexts'] = 'Ссылки в разных контекстах';
$_lang['setting_tinymcerte.links_across_contexts_desc'] = 'Если этот параметр включен, при создании внутренних ссылок редактор будет перечислять ресурсы из других контекстов. Если выключено, отображаются только ресурсы из того же контекста.';
$_lang['setting_tinymcerte.menubar'] = 'Строка меню';
$_lang['setting_tinymcerte.menubar_desc'] = 'Эта опция позволяет вам настроить меню, которые вы хотите отображать в строке меню. <a href="https://www.tiny.cloud/docs-4x/configure/editor-appearance/#menubar">https://www.tiny.cloud/docs-4x/configure/editor-appearance/#menubar</a>';
$_lang['setting_tinymcerte.object_resizing'] = 'Изменение размера объекта';
$_lang['setting_tinymcerte.object_resizing_desc'] = 'Этот параметр позволяет включать / выключать маркеры изменения размера изображений, таблиц или мультимедийных объектов.. <a href="https://www.tiny.cloud/docs-4x/configure/advanced-editing-behavior/#object_resizing">https://www.tiny.cloud/docs-4x/configure/advanced-editing-behavior/#object_resizing</a>';
...
$_lang['setting_tinymcerte.plugins_desc'] = 'Укажите, какие плагины должны быть включены, по умолчанию они не загружаются. <a href="https://www.tiny.cloud/docs-4x/configure/integration-and-setup/#plugins">https://www.tiny.cloud/docs-4x/configure/integration-and-setup/#plugins</a>';
...
$_lang['setting_tinymcerte.skin_desc'] = 'Выберите, какой скин использовать, он должен совпадать с именем скина. <a href="https://www.tiny.cloud/docs-4x/configure/editor-appearance/#skin">https://www.tiny.cloud/docs-4x/configure/editor-appearance/#skin</a>';
$_lang['setting_tinymcerte.statusbar'] = 'Статус бар';
$_lang['setting_tinymcerte.statusbar_desc'] = 'Булевое значение, показать или скрыть строку состояния. <a href="https://www.tiny.cloud/docs-4x/configure/editor-appearance/#statusbar">https://www.tiny.cloud/docs-4x/configure/editor-appearance/#statusbar</a>';
$_lang['setting_tinymcerte.valid_elements'] = 'Допустимые элементы';
$_lang['setting_tinymcerte.valid_elements_desc'] = 'Определяет, какие элементы останутся в редактируемом тексте при сохранении редактора. Вы можете использовать этот параметр, чтобы ограничить возвращаемый HTML подмножеством, как описано ниже: <a href="https://www.tiny.cloud/docs-4x/configure/content-filtering/#extended_valid_elements">https://www.tiny.cloud/docs-4x/configure/content-filtering/#extended_valid_elements</a>.';
