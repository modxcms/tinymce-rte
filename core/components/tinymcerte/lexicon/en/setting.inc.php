...
$_lang['setting_tinymcerte.min_width'] = 'Min width';
$_lang['setting_tinymcerte.min_width_desc'] = 'This option sets the minimum width that a user can stretch the entire TinyMCE interface (by grabbing the draggable area in the bottom right of the editor interface).';
$_lang['setting_tinymcerte.max_width'] = 'Max width';
$_lang['setting_tinymcerte.max_width_desc'] = 'This option sets the maximum width that a user can stretch the entire TinyMCE interface (by grabbing the draggable area in the bottom right of the editor interface).';
$_lang['setting_tinymcerte.width'] = 'Width';
$_lang['setting_tinymcerte.width_desc'] = 'Set the width of the editor.';
