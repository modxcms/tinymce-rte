/**
 * Based on link/plugins.js but with resource tree select added.
 *
 * Author: jako
 * Date: 2021-09-29
 */
...
(function () {
    ...
    var getDelta = function (persistentText, fieldName, catalog, data) {
      ...
      return value !== undefined ? findTextByValue(value, catalog).map(function (i) {
        return {
          ...
          text: hasPersistentText ? persistentText : i.display || i.text
        };
      }) : Optional.none();
    };
    ...
    var makeDialog = function (settings, onSubmit, editor) {
      ...
      var body = {
        ...
        items: flatten([
          urlInput,
          catalogs.link.map(ListOptions.createUi('link', _('tinymcerte.select_resource'))).toArray(),
          displayText,
          titleText,
          cat([
    ...
    function Plugin () {
      global$6.add('modxlink', function (editor) {
        setupButtons(editor);
