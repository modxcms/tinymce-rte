/**
 * Based on image/plugins.js but with float left/right added.
 *
 * Author: jako
 * Date: 2021-09-29
 */
...
(function () {
      ...
      return {
        ...
        items: [
          ...
          },
          {
            ...
            items: [
              {
                text: _('tinymcerte.float_none'),
                value: ''
              },
              {
                text: _('tinymcerte.float_left'),
                value: 'left'
              },
              {
                text: _('tinymcerte.float_right'),
                value: 'right'
              }
            ]
          }
    ...
    function Plugin () {
      global$5.add('modximage', function (editor) {
        setup(editor);
        register(editor);
        register$1(editor);
      });
